...
In this set of notes, you will continue to learn how to use the linear mixed-effects model to examine the mean change over time in a set of longitudinal/repeated measurements. You will also learn how to expand the model to allow cases to have different growth rates. Lastly, you will learn how to include covariates to evaluate whether the average growth rates vary for different groups. To do so, we will use data from the file [*minneapolis.csv*]((https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/minneapolis.csv)) (see [data codebook](http://zief0002.github.io/fluffy-ants/codebooks/minneapolis.html)).
...
# Import data
mpls = read_csv("https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/minneapolis.csv")
...
#| fig-alt: "Plot showing the change in reading score over time for 22 students. The average growth profile is displayed as a thicker line."
#| fig-width: 8
#| fig-height: 6
#| out-width: "70%"
...
#| fig-alt: "Plot showing the change in reading score over time for 22 students. The average growth profile is displayed as a thicker, red line."
#| fig-width: 8
#| fig-height: 8
#| out-width: "90%"
...
#| fig-alt: "Plot showing the change in reading scores over time conditioned on special education status. The average growth profile is displayed as a thicker line."
#| fig-width: 12
#| fig-height: 6
#| out-width: "70%"
ggplot(data = mpls, aes(x = grade, y = reading_score)) +
...
#| fig-alt: "Plot showing the average growth profile of reading scores over time for special education (blue) and non-special education (vermillion) students based on Model D. The individual growth profile for Student 8 (dotted line) is also displayed."
#| out-width: "70%"
...
#| fig-alt: "Plot showing the average growth profile of reading scores over time for special education (blue) and non-special education (vermillion) students based on Model E."
#| out-width: "70%"
ggplot(data = mpls, aes(x = grade-5, y = reading_score)) +
  geom_point(alpha = 0) +  #Add individual profiles
